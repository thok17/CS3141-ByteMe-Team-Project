...
def apps():
    ...
    isImage=PhotoImage(file="picAppIcon.png")
...
def groups():
    ...
    if (groupCount==0):
        if (syncGroup==""):
            lblListenGroup=Label(mainFrameGroup,text="Listening to no groups",bg="limegreen", fg="black", font=("Helvetica",10,"bold"),width=45)
            lblListenGroup.grid(row=0,column=0,columnspan=2,sticky=W)
        else:
            lblListenGroup=Label(mainFrameGroup,text="Listening to group "+syncGroup,bg="limegreen", fg="black", font=("Helvetica",10,"bold"))
            lblListenGroup.grid(row=0,columnspan=2)

        lblActiveGroup=Label(mainFrameGroup,text="My active groups: ",bg="limegreen", fg="black", font=("Helvetica",10,"bold"))
        lblActiveGroup.grid(row=1, column=0,ipadx=5,ipady=5)

        lblMyGroup=Label(mainFrameGroup,text="My own groups: ",bg="limegreen", fg="black", font=("Helvetica",10,"bold"))
        ...
        lbljoinGroup=Label(mainFrameGroup,text="Join group: ",bg="limegreen", fg="black", font=("Helvetica",8,"bold"))
        ...
        btnJoin.grid()
        lblCreateGroup=Label(mainFrameGroup,text="Create group : ",bg="limegreen", fg="black", font=("Helvetica",8,"bold"))
...
mainFrameGroup=Frame(root,bg="limegreen")
